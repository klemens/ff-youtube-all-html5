...
exports.main = function(options) {
    ...
    // change deleted api and embed methods to default
    if("api" === simplePrefs.prefs["yt-loadtype"] ||
       "iframe" === simplePrefs.prefs["yt-loadtype"]) {
        simplePrefs.prefs["yt-loadtype"] = "ie";
    }
    ...
    var playerHeights = [360, 480, 720, 1080, 1440];
    ...
    simplePrefs.on("", function(pref) {
        ...
        if("yt-loadtype" == pref) {
            if("ie" == settings["yt-loadtype"]) {
                ...
                // ok to call even when switching between non-ie methods,
