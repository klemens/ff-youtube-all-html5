...
exports.main = function(options) {
    ...
    // pref change: yt-fix-volume(bool) -> yt-video-volume(menulist)
    if("yt-fix-volume" in simplePrefs.prefs) {
        if(simplePrefs.prefs["yt-fix-volume"]) {
            simplePrefs.prefs["yt-video-volume"] = "100";
        }
        delete simplePrefs.prefs["yt-fix-volume"];
    }
    ...
    settings["yt-video-volume"] = simplePrefs.prefs["yt-video-volume"];
